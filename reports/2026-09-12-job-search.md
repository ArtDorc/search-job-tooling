# Daily Job Search Report — 2026-09-12
...
|---|-------|------|---------|----------|------|
| 1 | 18 | Développeur fullstack expert (H/F) - CDI | Collective.work | 59 - Lille | [offer](https://candidat.francetravail.fr/offres/recherche/detail/6845567) |

## Why each fits

1. **Développeur fullstack expert (H/F) - CDI — Collective.work** (59 - Lille): Recoupe le profil sur : fullstack.

## Tailored cover letters (top 4)

### 1. Collective.work — Développeur fullstack expert (H/F) - CDI
Link: https://candidat.francetravail.fr/offres/recherche/detail/6845567

```
Madame, Monsieur,

Développeur Full-stack chez Archimed à Lille, je vous propose ma candidature pour le poste de Développeur fullstack expert (H/F) - CDI au sein de Collective.work.
